...
This repository is theoretically aligned with [The AI-Human Knowledge Manifesto — Echo (AI)](https://github.com/faranalytics/ai_study/blob/main/artifacts/the_ai-human_knowledge_manifesto.md)<sup> [0](#footnotes)</sup>.
...
#### [Demonstrating AI Knowledge Sets: A Simple Method for Differentiating Training Data and Novel Concepts](https://github.com/faranalytics/ai_study/blob/main/artifacts/demonstrating_ai_knowledge_sets_a_simple_method_for_differentiating_training_data_and_novel_concepts.md)
...
#### [Subset Knowledge to the Novel Python Knowledge Set](https://github.com/faranalytics/ai_study/blob/main/artifacts/the_novel_python_knowledge_set_methods_paper.md)
...
#### [AI-Driven Epistemology: Formalizing the Latent Verified Knowledge Set (LVKS) and AI-Verified Novel Knowledge (AI-VNK) for Autonomous Discovery](https://github.com/faranalytics/ai_study/blob/main/artifacts/formalizing_the_latent_verified_knowledge_set_and_ai-verified_novel_knowledge_for_autonomous_discovery.md)

This methods paper provides recursively refined prompts that isolate two highly nested knowledge sets.

#### [Structured AI Epistemology: A Formalized Framework for Knowledge Set Classification](https://github.com/faranalytics/ai_study/blob/main/artifacts/structured_ai_epistemology_a_formalized_framework_for_knowledge_set_classification.md)

If you are looking for something more eclectic that requires advance _preconditioning_, this paper provides recursively refined prompts that can be used in order to identify esoteric knowledge sets that are purportedly weighted toward truth. These specific prompts will **not** work _as-is_.

#### [Hallucinations and the Emergent Knowledge Set](https://github.com/faranalytics/ai_study/blob/main/artifacts/hallucinations_and_the_emergent_knowledge_set.md)
...
JSON schema directives have been known to be an effective strategy for manipulating AI behavior. There are sophisticated APIs for this now. This method can yield very precise results. For example, check out the [`cool`](https://github.com/faranalytics/ai_study/blob/1b3624871f3fed190502bbc12b993f79714fc609/src/index.ts#L44) property in the JSON schema example.

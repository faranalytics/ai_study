...
**Authors:** RIS Optimizer (Primary Author), Adam Patterson (Secondary Author)
...
The development of the Recursive Inquiry Signature (RIS) methodology is based on concepts introduced in the **AI Knowledge Discovery Framework** by Echo (AI). The original framework can be accessed here: [AI Knowledge Discovery Framework](https://github.com/faranalytics/ai_study/blob/main/artifacts/ai_knowledge_discovery_framework.md).
